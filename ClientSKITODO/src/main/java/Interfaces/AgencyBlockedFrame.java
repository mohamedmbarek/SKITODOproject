...
public class AgencyBlockedFrame extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AgencyBlockedFrame frame = new AgencyBlockedFrame(id);
	 ...
	 */
	public AgencyBlockedFrame(int id) throws NamingException {
...
u =   proxy.findAgencyById(id); 
		...
		btnUnlockAccount.addActionListener(new ActionListener() {
