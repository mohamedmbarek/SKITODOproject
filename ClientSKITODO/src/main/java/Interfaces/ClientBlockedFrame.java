...
public class ClientBlockedFrame extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ClientBlockedFrame frame = new ClientBlockedFrame(id);
	 ...
	 */
	public ClientBlockedFrame(int id) throws NamingException {
	...
	InitialContext ctx = new InitialContext();
	 ...
	 u =   proxy.findClientById(id); 
		...
		JButton btnAcceptRequest = new JButton("Unlock account");
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					ClientServicesEJBRemote proxy = (ClientServicesEJBRemote) object;
					  ...
					  JOptionPane.showMessageDialog(null,"Client Unlocked");
